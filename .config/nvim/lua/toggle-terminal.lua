...
vim.keymap.set({ "n", "t" }, "<leader>eh", function()
  close_terminal("horizontal")
end, { noremap = true, silent = true, desc = "Close horizontal terminal" })
vim.keymap.set({ "n", "t" }, "<leader>ev", function()
  close_terminal("vertical")
end, { noremap = true, silent = true, desc = "Close vertical terminal" })
vim.keymap.set({ "n", "t" }, "<leader>ef", function()
  close_terminal("floating")
